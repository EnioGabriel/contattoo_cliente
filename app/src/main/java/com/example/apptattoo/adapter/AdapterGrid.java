...
public class AdapterGrid extends ArrayAdapter<String> {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        //Inflando Layout apenas uma vez
        if (convertView == null){
            viewHolder = new ViewHolder();
            LayoutInflater layoutInflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
            convertView = layoutInflater.inflate(layoutResource, parent, false);
            viewHolder.progressBar = convertView.findViewById(R.id.progressGridPostagem);
            viewHolder.imagem = convertView.findViewById(R.id.imgGridPerfil);
            convertView.setTag(viewHolder);//usado para recuperar um objeto
        }else {
