...
public class Usuario implements Serializable {
    ...
    public void salvarDados(){
        ...
        DatabaseReference usuarioRef = firebaseRef.child("usuarios").child(getId());//criando nó com ID
    ...
    public void atualizarDados(){
        DatabaseReference firebaseRef = ConfiguracaoFirebase.getFirebase();
        DatabaseReference usuarioRef = firebaseRef.child("usuarios").child(getId());
        DatabaseReference nomesUsuariosRef = firebaseRef.child("nomesUsuarios").child("CLIENTES").child(getId());
