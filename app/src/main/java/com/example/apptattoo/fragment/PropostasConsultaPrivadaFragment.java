...
public class PropostasConsultaPrivadaFragment extends Fragment {
    ...
    public PropostasConsultaPrivadaFragment() {
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_propostas_consulta_privada, container, false);

        recyclerViewPropostas = view.findViewById(R.id.recyclerViewPropostasConsultaPrivada);
        ...
        recyclerViewPropostas.addOnItemTouchListener(new RecyclerItemClickListener(
                ...
                new RecyclerItemClickListener.OnItemClickListener() {
                    ...
                    public void onItemClick(View view, int position) {
                        ...
                        i.putExtra("tipoProposta", "consultaPrivada");
