...
public class EditarPerfilActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ref = database.getReference().child("usuarios").child(identificarUsuario);
        ...
        txtEditNomeUsuario.addTextChangedListener(new CustomTextWatcher(txtEditNomeUsuario,500) {
            @Override
    ...
    public void deslogarUsuario(){
        try {
            ...
            Toast.makeText(getApplicationContext(), "Erro ao deslogar usuário"+ e.getMessage().toString(),Toast.LENGTH_SHORT).show();
        }
    }
