...
import com.example.apptattoo.fragment.AgendaFragment;
import com.example.apptattoo.fragment.FeedFragment;
import com.example.apptattoo.fragment.PerfilFragment;
import com.example.apptattoo.fragment.PostagemFragment;
import com.example.apptattoo.fragment.TatuarFragment;
...
public class MainActivity extends AppCompatActivity {
    ...
    //motodo para tratar evento de click no BottomNavigation
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                switch (item.getItemId()) {
                    ...
                    case R.id.ic_agenda:
                        ...
                        return true;
                    case R.id.ic_tattoo:
                        fragmentTransaction.add(R.id.viewPager, new TatuarFragment()).commit();
                        return true;
                }
                return false;
            }
