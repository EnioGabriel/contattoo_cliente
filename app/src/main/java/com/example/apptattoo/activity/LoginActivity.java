...
public class LoginActivity extends AppCompatActivity {
    ...
    //Verifica se o usuario que fez o login esta no grupo de usuarios
    public void isUsuario(String idUsuario ) {
        DatabaseReference usuarioRef = ConfiguracaoFirebase.getFirebase().child("usuarios").child(idUsuario);
        usuarioRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    ...
                    auth.signOut();
                    Toast.makeText(getApplicationContext(), "Erro ao fazer login, certifique-se que é um usuário do tipo cliente", Toast.LENGTH_SHORT).show();
                }
            }
